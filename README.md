...
**Engenharia da Computação | Mobile Dev | Qualidade de Software**
<div>
...
<a href = "mailto:matheus.canto@icomp.ufam.edu.br"><img loading="lazy" src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" target="_blank"></a>
...
#### Sou um desenvolvedor focado em lógica e resolução de problemas complexos. Com base em Manaus (AM), atuo com foco em **Pesquisa e Desenvolvimento (P&D)** e **Desenvolvimento Mobile**.

🧠 **Neurodiversidade como Potência:** Como uma pessoa no espectro autista (TEA) e com TDAH, utilizo meu hiperfoco e atenção aos detalhes para garantir códigos limpos, encontrar falhas (bugs) e criar documentações estruturadas.

#### 🚀 Experiência Principal
*   **Pesquisador Bolsista (Projeto SUPER/Samsung):** Desenvolvi um "Computador de Voo" completo em **Dart/Flutter** (Mobile) ao longo de 1 ano.
...
*   **Mobile:** Flutter, Dart (Foco em UI, ajuste de movimwnto e implementação do simulador).
*   **Back-end & Ferramentas:** Python, C, Git, Jupyter Notebook e Java.
*   **Interesses:** Desenvolvimento de Apps, Testes de Software, Lógica de Programação.
